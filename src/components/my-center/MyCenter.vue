  ...
  <div class="wrap center-wrap">
    ...
    <div class="mycenter-content">
      <div class="suspend-box">
        <div class="operation-box">
          <div class="operation-title">
            <div
              class="user-type"
              @click="seleUserType('buy')"
              :class="myData.userTypeOpt.usertype?'switching':''"
            >
              我是买家
        ...
        <div class="box-content" @click="goSele('assetsManage')">
          <div class="box-content-cell">
            ...
            <div class="manage-detail">
              <span v-text="myData.manageData.usableBalance"></span>
              元
            </div>
          </div>
          ...
          <div class="box-content-cell">
            ...
            <div class="manage-detail">
              <span v-text="myData.manageData.frostBalance"></span>
              元
            </div>
          </div>
          <div class="vertical-bg"></div>
          <div class="box-content-cell">
            ...
            <div class="manage-detail">
              <span v-text="myData.manageData.cashPledge"></span>
              元
            </div>
          </div>
        </div>
      ...
      <div class="strip-wrap">
        ...
        <div class="sell-strip" @click="goSele('shop')">
          <div class="left-strip shop">
            <img src="../../../static/image/mycenter/shop.png" alt />
            <!-- <span>我的店铺</span> -->
            <span v-if="myData.is_shop == 1">我的店铺</span>
            <span v-if="myData.is_shop == 2">申请开店</span>
          </div>
          <div class="right-opt">
            <span class="red-bg" v-if="myData.pactNews > 0" v-text="myData.pactNews"></span>
            <img src="../../../static/img/order/next.png" alt />
        ...
        <div class="sell-strip" @click="linkServer">
...
export default {
        ...
        userTypeOpt: {
          ...
          buyTit: [
            {
              key: 1,
              name: "unpaid",
              imgSrc: "./static/image/mycenter/unpaid.png",
              val: "待支付",
              link: "b_unpaid"
            },
            {
              key: 2,
              name: "trading",
              imgSrc: "./static/image/mycenter/trading.png",
              val: "交易中",
              link: "b_trading"
            },
            {
              key: 3,
              name: "receiv",
              imgSrc: "./static/image/mycenter/receiv.png",
              val: "待收货",
              link: "b_receiv"
            },
            {
              key: 4,
              name: "tradsuccess",
              imgSrc: "./static/image/mycenter/tradsuccess.png",
              val: "交易成功",
              link: "b_tradsuccess"
            },
            {
              key: 5,
              name: "order",
              imgSrc: "./static/image/mycenter/order.png",
              val: "全部订单",
              link: "b_order"
            }
          ],
          sellTit: [
            ...
            },
            {
              key: 2,
              name: "deliver",
              imgSrc: "./static/image/mycenter/deliver.png",
              val: "已发货",
              link: "s_wait"
            },
            {
            ...
            },
            {
              key: 4,
              name: "deal",
              imgSrc: "./static/image/mycenter/deal.png",
              val: "交易失败",
              link: "s_fail"
            },
            {
  ...
  methods: {
    ...
    goSele(flag) {
      ...
      if (token == undefined || token == "") {
        ...
        if (flag == "changePassword") {
          ...
          //店铺
          if (that.myData.is_shop == 1) {
            that_r.push({ name: "MyShop" });
          } else if (that.myData.is_shop == 2) {
            that_r.push({ name: "ShopApplication" });
          }
            ...
            if (that.myData.is_identify == 1) {
              if (that.myData.is_bank == 1) {
                that_r.push({
                  ...
                  query: { type: that.myData.is_identify }
                });
              } else {
                that.$router.push({
    ...
    logoutFn() {
      ...
      that.$axios
        .post(process.env.API_HOST + "logout")
        .then(res => {
          // console.log(res);
          if (res.status == 200) {
    ...
    getData() {
      var that = this;
      that.$axios
        .post(process.env.API_HOST + "userInfo")
        .then(res => {
          // console.log(res)
          if (res.status == 200) {
            if (res.data.code == 200) {
              ...
              that.myData.manageData.usableBalance = Number(
                data.user_info.total_money
              ); //可用余额
              that.myData.manageData.frostBalance = Number(
                data.user_info.limit_money
              ); //冻结金额
              that.myData.manageData.cashPledge = Number(
                data.user_info.deposit
              ); //押金
              ...
              that.myData.is_shop = data.user_info.is_shop; //店铺判断
              ...
              that.tipAll.seller_discuss_msg =
                data.user_info.seller_discuss_msg;
              for (var i in that.myData.userTypeOpt.buyTit) {
                if (that.myData.userTypeOpt.buyTit[i].name == "unpaid") {
                  ...
                  that.myData.userTypeOpt.buyTit[i].name == "trading"
                ) {
              ...
              for (var i in that.myData.userTypeOpt.sellTit) {
                if (that.myData.userTypeOpt.sellTit[i].name == "trading") {
                  ...
                  that.myData.userTypeOpt.sellTit[i].name == "deliver"
                ) {
...
.mycenter-top {
  background-image: url(../../../static/image/personal1.jpg);
