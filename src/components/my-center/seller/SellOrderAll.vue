        ...
        <div class="orderAll-content">
            <div class="orderAll-cell">
                <div class="orderAll-strip" @click="toLink('trading')">
                    ...
                    <span class="num">({{trading}})</span>
                    <div class="right-opt">
                        <img src="../../../../static/img/order/next.png" alt />
                    </div>
                </div>
                <div class="orderAll-strip" @click="toLink('confirm')">
                    <span class="orderAll-lefttext">待买家确认收货</span>
                    <span class="num">({{buyer_confirm}})</span>
                    <div class="right-opt">
                        <img src="../../../../static/img/order/next.png" alt />
                    </div>
                </div>
                <div class="orderAll-strip" @click="toLink('arbitrate')">
                    ...
                    <span class="num">({{trade_arbitrate}})</span>
                    <div class="right-opt">
                        <img src="../../../../static/img/order/next.png" alt />
                    </div>
                </div>
                <div class="orderAll-strip" @click="toLink('success')">
                    ...
                    <span class="num">({{trade_success}})</span>
                    <div class="right-opt">
                        <img src="../../../../static/img/order/next.png" alt />
                    </div>
                </div>
                <div class="orderAll-strip" @click="toLink('fail')">
                    ...
                    <span class="num">({{trade_fail}})</span>
                    <div class="right-opt">
                        <img src="../../../../static/img/order/next.png" alt />
                    </div>
                </div>
...
export default {
    ...
    methods:{
        ...
        getData() {
            var that =this;
            that.$axios.post(process.env.API_HOST+"sellerOrder").then((res)=>{
                if(res.status == 200){
                    that.showLoading = false;
                    if(res.data.code == 200){
                        var data = res.data.data;
                        that.trade_arbitrate = data.trade_arbitrate;
                        that.buyer_confirm = data.trade_confirm;
