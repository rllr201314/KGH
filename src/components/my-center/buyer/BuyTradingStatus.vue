            ...
            <div class="trad-cell" v-for="(item,index) in goodsData" :key="index">
                ...
                <div class="orderInfo">
                    ...
                    <div class="price-status">
                        ...
                        <span class="order-status dominant-bg" v-if="item.rent_method == 1 || item.rent_method == 4" v-text="item.bind_status"></span>
                        <span class="order-status dominant-bg" v-else-if="item.rent_method == 2" v-text="item.rent_status"></span>
                ...
                <div class="order-operate">
                    ...
                    <div class="right-operate">
                        <span class="pay dominant-bg" @click="goStatus(item.rent_method,item.order_id)">查看</span>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        getData() {
            var that = this;
            that.$axios
                .post(process.env.API_HOST+"buyerTrading")
                .then(res => {
                    // console.log(res);
                    if (res.status == 200) {
