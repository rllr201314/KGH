            ...
            >
                ...
                <div class="goods-strip-content">
                    ...
                    <div class="goods-ico">
                        <img
                            v-if="item.is_safe == 1"
                            src="../../static/image/goods/safe-icon.png"
                            alt
                        />
                        <img
                            v-if="item.is_stage == 1"
                            src="../../static/image/goods/stage-icon.png"
                            alt
                        />
                        <img
                            v-if="item.is_check == 1"
                            src="../../static/image/goods/test-icon.png"
                            alt
                        />
                    </div>
                </div>
...
export default {
    ...
    mounted() {
        ...
        that.time = setInterval(function () {
            $('.recent-des-wrap').find('ul').animate({
                marginTop: "-.3rem"
            }, 500, function () {
                $(this).css({
                    marginTop: "0rem"
