                    ...
                    <div v-if="is_list == 1">
                        ...
                        >
                            ...
                            <div class="list-right">
                                ...
                                <div
                                    class="list-parent"
                                    v-for="(value,i) in item.business_info"
                                    :key="i"
                                >
                                    <div
                                        class="list-ico vs"
                                    ...
                                    ></div>
                                    <div
                                        class="list-ico product"
                                        v-else-if="value.value == 1"
                                        v-text="value.name"
                                    ></div>
                                    <div
                                        class="list-ico rent"
                                        v-else-if="value.value == 2"
                                        v-text="value.name"
                                    ></div>
                                    <div
                                        class="list-ico wz"
                                        v-else-if="value.value == 5"
                                        v-text="value.name"
                                    ></div>
                                </div>
                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            book_list: [
                {
                    img: 'http://192.168.1.253:8800/static/images/category/5d8d7ab9c9bd5.jpg',
                }, {
                    img: 'http://192.168.1.253:8800/static/images/category/5d8d7ab9c9bd5.jpg',
                }, {
                    img: 'http://192.168.1.253:8800/static/images/category/5d8d7ab9c9bd5.jpg',
