<template>
    <div class="goods-details-wrap wrap">
        ...
        <div class="goods-details-title">
            ...
            <div class="title-goods-price" v-if="detailData.rent_method == 1 || detailData.rent_method == 5">
        ...
        <div v-if="recommendData != ''">
            <div class="goods-strip" v-for="(item,index) in recommendData" :key="index" @click="goDetail(item.goods_id)">
        ...
        <div class="goods-details-bottom">
            ...
            <div class="buy goods-details-bottom-right" @click="buyFn" v-if="detailData.rent_method == 1 || detailData.rent_method == 5">立即购买</div>
        </div>
        <!-- 议价弹框 -->
        <div class="hoodle" v-show="showShade">
            <img src="../../../static/image/bargaining.png" alt="">
                    ...
                    if (res.status == 200) {
                        ...
                        if (res.data.code == 200) {
                            ...
                            if (data == "") {
                                ...
                                if(data.goods_info.rent_method == 1 || data.goods_info.rent_method == 5){
                                    that.flow_type = 1;
